...
CREATE TABLE `CONTACT_AND_BASIC_INFO` (
  `userdetails_pk` int(11) NOT NULL,
  `religions_pk` int(11) DEFAULT NULL,
  `contact_and_basic_info_religious_view` varchar(500) DEFAULT NULL,
  `contact_and_basic_info_interested_in` char(1) DEFAULT NULL,
  `political_views_pk` int(11) DEFAULT NULL,
  `contact_and_basic_info_political_view` varchar(500) DEFAULT NULL,
  `contact_and_basic_info_user_address` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`userdetails_pk`),
  KEY `fk_CONTACT_AND_BASIC_INFO_4_idx` (`religions_pk`),
  KEY `fk_CONTACT_AND_BASIC_INFO_5_idx` (`political_views_pk`),
  ...
  CONSTRAINT `fk_CONTACT_AND_BASIC_INFO_4` FOREIGN KEY (`religions_pk`) REFERENCES `RELIGIONS` (`religions_pk`) ON DELETE SET NULL ON UPDATE NO ACTION,
  CONSTRAINT `fk_CONTACT_AND_BASIC_INFO_5` FOREIGN KEY (`political_views_pk`) REFERENCES `POLITICAL_VIEWS` (`political_views_pk`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `CONTACT_AND_BASIC_INFO`
--

LOCK TABLES `CONTACT_AND_BASIC_INFO` WRITE;
/*!40000 ALTER TABLE `CONTACT_AND_BASIC_INFO` DISABLE KEYS */;
INSERT INTO `CONTACT_AND_BASIC_INFO` VALUES (3,6,'I am JAIN','F',2,'CONGRESS','Ahmedabad'),(4,1,'I am one of the Hindus','F',1,'I support Congress.','ahmedabad'),(5,1,'I am proud of being Hindu','M',1,'I support Bhajapa.','bhuj');
/*!40000 ALTER TABLE `CONTACT_AND_BASIC_INFO` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `LANGUAGES` (
  `language_pk` int(11) NOT NULL AUTO_INCREMENT,
  `languages_language_name` varchar(25) NOT NULL,
...
INSERT INTO `LANGUAGES` VALUES (1,'English'),(2,'Hindi'),(3,'Gujarati'),(4,'Kannada'),(5,'Telugu'),(6,'Tamil'),(7,'Malayalam'),(8,'French'),(9,'Chienese'),(10,'Punjabi');
...
CREATE TABLE `POLITICAL_VIEWS` (
  `political_views_pk` int(11) NOT NULL AUTO_INCREMENT,
  `political_views_name` varchar(75) NOT NULL,
  PRIMARY KEY (`political_views_pk`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `POLITICAL_VIEWS` WRITE;
/*!40000 ALTER TABLE `POLITICAL_VIEWS` DISABLE KEYS */;
INSERT INTO `POLITICAL_VIEWS` VALUES (1,'Bhajapa'),(2,'Congress');
/*!40000 ALTER TABLE `POLITICAL_VIEWS` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `RELIGIONS` (
  `religions_pk` int(11) NOT NULL AUTO_INCREMENT,
  `religions_religion_name` varchar(45) NOT NULL,
  PRIMARY KEY (`religions_pk`),
  UNIQUE KEY `religions_religion_name_UNIQUE` (`religions_religion_name`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `RELIGIONS` VALUES (4,'cristian'),(1,'hindu'),(6,'jainism'),(2,'muslim'),(5,'parsism'),(3,'shikh');
...
INSERT INTO `USERDETAILS` VALUES (1,'1','GUNJAN','ACHARYA','9897949291','ABS@GMAIL.COM','ASD','m','1995-05-23','gunjan','kgvjjbk',2),(2,'2','SHACHI','BHAVSAR','9687534498','shachi@gmail.com','shachi@123','f','1994-02-12','shachi','hddhd',1),(3,'3','PRIYESH','DOSHI','','','doshi@123','m','1994-01-12','default','ui',0),(4,'4','RAJ','PARIKH','9696969696','raju@gmail.com','raju@123','m','1993-11-02','default','djjd',0),(5,'5','AVANI','THAKKER','9797979797','avani@gmail.com','avani@123','f','1993-09-07','default','djdjd',0),(6,'6','Meet','Patel','9595959559','meet@gmail.com','123','m','1995-05-08','meet','default',2),(7,'7','Sumedh','Gupte','9876543211',NULL,'abc','M','1990-04-04','sumedh','sdc',1);
...
CREATE TABLE `USER_LANG` (
  `user_lang_pk` int(11) NOT NULL AUTO_INCREMENT,
  `userdetails_pk` int(11) NOT NULL,
  `lang_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`user_lang_pk`),
  KEY `fk_USER_LANG_1_idx` (`userdetails_pk`),
  KEY `fk_USER_LANG_2_idx` (`lang_id`),
  CONSTRAINT `fk_USER_LANG_1` FOREIGN KEY (`userdetails_pk`) REFERENCES `USERDETAILS` (`userdetails_pk`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_USER_LANG_2` FOREIGN KEY (`lang_id`) REFERENCES `LANGUAGES` (`language_pk`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `USER_LANG` VALUES (1,5,1),(2,5,2),(3,5,3),(4,4,1),(5,4,2),(6,4,3),(7,3,1),(8,3,2),(9,3,3);
...
-- Dump completed on 2017-03-08 23:50:12
