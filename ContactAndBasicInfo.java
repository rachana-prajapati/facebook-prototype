...
public class ContactAndBasicInfo {
	...
	private String political_views_name;
	private String contact_and_basic_info_political_view;
	...
	public ContactAndBasicInfo(String userdetails_mobile, String userdetails_email,
			String contact_and_basic_info_user_address, ArrayList<String> websites_links_url,
			ArrayList<String> social_links_url, String userdetails_dob, char userdetails_gender,
			ArrayList<String> languages_language_name, String religions_religion_name,
			String contact_and_basic_info_religious_view, char contact_and_basic_info_interested_in,
			String political_views_name,String contact_and_basic_info_political_view) {
		super();
		...
		this.political_views_name = political_views_name;
		this.contact_and_basic_info_political_view=contact_and_basic_info_political_view;
	}
	...
	public String getPolitical_views_name() {
		return political_views_name;
	}

	public void setPolitical_views_name(String political_views_name) {
		this.political_views_name = political_views_name;
	}

	public String getContact_and_basic_info_political_view() {
		return contact_and_basic_info_political_view;
	}

	public void setContact_and_basic_info_political_view(String contact_and_basic_info_political_view) {
		this.contact_and_basic_info_political_view = contact_and_basic_info_political_view;
	}
